    ...
    <div className="main_frame_content_Secondcomment">
      {active === "Reply" && (
        <div style={{ display: "flex" }}>
          <div>
            <Avatar src={img3} className="avatar_authors1"></Avatar>
          </div>

          <Paper className="paper_content_second">
            <div style={{ display: "flex" }}>
            ...
            <div className="frame_name_more1_second">
          ...
          <Paper className="paper_content_second">
            ...
            <div className="frame_text_reply_comment">
              <TextareaAutosize
                ...
                className="textarea_comment_second"
                minRows={4}
              />
